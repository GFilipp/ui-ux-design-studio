...
5b. **Respect the reader's hit area and choice load.** Tap targets are at least 44px on touch breakpoints (Fitts's law; Apple HIG 44pt, Material 48dp, WCAG 2.5.5) — BLOCKING. Choice sets over ~10 siblings and primary nav over 7 links are surfaced as warnings (Hick's and Miller's laws): sometimes a 12-logo wall is right, so the machine flags the load and you decide.
